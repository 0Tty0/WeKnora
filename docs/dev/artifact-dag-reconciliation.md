...
- PostgreSQL: `migrations/versioned/000084_processing_artifacts.{up,down}.sql`
- SQLite: `migrations/sqlite/000004_processing_artifacts.{up,down}.sql`
...
4. optionally run migration `000084` down.
